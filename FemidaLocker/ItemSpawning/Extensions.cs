...
namespace FemidaLocker.ItemSpawning
{
    /// <summary>
    ...
    {
        private const string BalanceSheetKey = "FemidaLocker_ItemSpawning_BalanceSheet";
        private const string ChestItemKey = "FemidaLocker_ItemSpawning_ChestItem";
        private const string DestroyedProjectileIdKey = "FemidaLocker_ItemSpawning_DestroyedProjectileId";
        private const string LastUpdatedItemKey = "FemidaLocker_ItemSpawning_LastUpdatedItem";
        private const string ShopKey = "FemidaLocker_ItemSpawning_Shop";
        private const string WeaponRackItemIdKey = "FemidaLocker_ItemSpawning_WeaponRackItemId";
